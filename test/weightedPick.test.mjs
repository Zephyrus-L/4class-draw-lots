...
assert.equal(weightedPick(pool, { '0-李四': 50 }, '001', () => 0.49).name, '李四')
assert.equal(weightedPick(pool, { '0-李四': 50 }, '001', () => 0.51).name, '王五')
assert.equal(weightedPick(pool, { '0-李四': 80, '0-王五': 80 }, '001', () => 0.99).name, '王五')
